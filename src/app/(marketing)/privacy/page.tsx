        ...
        <div className="max-w-none space-y-10 text-text-muted leading-relaxed">
          ...
          <section>
            ...
            <address className="not-italic mt-3 p-4 bg-surface rounded-[var(--radius)] border border-border text-sm">
              {contact ? (
                ...
                <>
                  The operator of this site — see the{" "}
                  <Link
                    href="/imprint"
            ...
            <p className="mt-4">
              For all data protection enquiries, including the exercise of your data subject rights, please contact us
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-none">
              {[
                [
                  "Account data",
                  "Your email address, display name, and — if you register via Google OAuth — your Google profile name and profile picture URL.",
                ],
                [
                  "Link page content",
                  "The links, text, images, and configuration you choose to publish on your Ultralink page. This content is stored by us to operate the service.",
                ],
                [
                  "Usage analytics",
                  "Aggregated and per-link click counts, referring social platforms, approximate geographic location derived from IP address (country level), device type (mobile/desktop), and browser type.",
                ],
                [
                  "IP address",
                  "Temporarily recorded for security, rate-limiting, fraud prevention, and for deriving country-level geo-data used in your analytics dashboard. Not stored long-term beyond what is necessary for these purposes.",
                ],
                [
                  "Cookies and session data",
                  "Session tokens and authentication cookies are used to keep you logged in. See Section 8 for details.",
                ],
                [
                  "Billing data",
                  "Payment processing is handled by Stripe. We do not store your full credit card number. We receive and retain limited transaction metadata (plan purchased, amount, date, Stripe customer ID) to manage your subscription.",
                ],
                [
                ...
                <li key={title as string} className="pl-4 border-l-2 border-border">
                  <span className="font-medium text-text">{title}:</span> {desc}
                </li>
              ))}
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>
                <span className="font-medium text-text">Contract (Art. 6(1)(b) GDPR):</span> Processing necessary to
                provide the Ultralink service you signed up for — account management, delivering link pages, processing
                subscription payments.
              </li>
              <li>
                <span className="font-medium text-text">Legitimate interests (Art. 6(1)(f) GDPR):</span> Analytics to
                improve the service, security and fraud prevention, communicating service-critical updates.
              </li>
              <li>
                <span className="font-medium text-text">Consent (Art. 6(1)(a) GDPR):</span> Where we explicitly ask for
                consent — for example, for non-essential cookies or optional marketing communications. You may withdraw
                consent at any time.
              </li>
              <li>
                <span className="font-medium text-text">Legal obligation (Art. 6(1)(c) GDPR):</span> Retention of
                invoices and transaction records as required by German commercial and tax law.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              We use the following third-party sub-processors to operate the service. Each has been selected for
              compliance with GDPR and appropriate security standards:
            </p>
            ...
            <p className="mt-4 text-sm">
              SCCs = EU Standard Contractual Clauses, providing an adequate legal mechanism for international transfers
          ...
          <section>
            ...
            <p>
              As shown in Section 4, some of our sub-processors are based in the United States. These transfers are
              conducted under Standard Contractual Clauses (SCCs) approved by the European Commission, ensuring an
              adequate level of data protection. You may request a copy of the applicable SCCs by contacting us at
              support@ultralink.bio.
            </p>
          </section>
            ...
            <ul className="mt-3 space-y-2 list-none">
              {[
                ...
                [
                  ...
                  "You have the right to complain to the competent supervisory authority. In Germany, this is the relevant Landesbeauftragter für den Datenschutz. You can also contact the European Data Protection Board (EDPB).",
                ],
              ].map(([title, desc]) => (
                <li key={title as string} className="pl-4 border-l-2 border-border">
                  <span className="font-medium text-text">{title}:</span> {desc}
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li>
                ...
                request, except where legal retention obligations apply.
              </li>
              <li>Analytics data (aggregated click data) is retained for up to 24 months and then deleted.</li>
              <li>
                Transaction and invoice records are retained for 10 years as required by German commercial law (§ 257
                HGB) and tax law (§ 147 AO).
              </li>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 list-disc list-inside">
              ...
              <li>
                ...
                third-party advertising cookies, social media tracking pixels, or behavioural profiling.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Ultralink is not directed at children under the age of 16. We do not knowingly collect personal data from
              children. If you believe a child has provided us with personal data, please contact us and we will delete
              it promptly.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may update this Privacy Policy from time to time. Material changes will be communicated to you by email
              or by a prominent notice on the service. The &ldquo;Last updated&rdquo; date at the top of this page
              reflects the date of the most recent revision. Continued use of the service after changes take effect
      ...
      <footer className="border-t border-border px-4 sm:px-6 py-6 mt-12">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-text-muted">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/privacy" className="hover:text-text transition-colors text-text-muted">
              Privacy Policy
            </Link>
