    ...
    <div className="min-h-dvh bg-bg dark-theme">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="space-y-10 text-text-muted leading-relaxed">
          ...
          <section>
            <p>
              These Terms of Service (&ldquo;Terms&rdquo;) govern your use of Ultralink, a hosted link-in-bio service
              operated by Franciszek Kaminski, Germany (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;Ultralink&rdquo;).
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li>
                One person or legal entity may not maintain more than one free account. Agency workspaces are separate
                from personal accounts and subject to the applicable plan terms.
              </li>
              <li>
                You must notify us immediately at support@ultralink.bio of any unauthorised access to your account.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              You may use Ultralink only for lawful purposes and in accordance with these Terms. You agree not to:
            </p>
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <span className="font-medium text-text">Upload, link to, or publish illegal content</span> — including
                content that violates copyright, constitutes harassment, defamation, hate speech, or is otherwise
                prohibited by applicable law.
              </li>
              <li>
                <span className="font-medium text-text">Publish malware, phishing, or deceptive content</span> — any
                content designed to deceive end users about its origin, purpose, or destination.
              </li>
              <li>
                <span className="font-medium text-text">Cloak your links</span> — you may not use Ultralink to serve
                different content or URLs to platform crawlers (Instagram, TikTok, etc.) than those served to human
                visitors. This includes but is not limited to: JavaScript-based redirect masking, user-agent switching,
                or any technique that deceives automated systems about a link&apos;s real destination. Violation of this
                rule will result in immediate account termination.
              </li>
              <li>
                <span className="font-medium text-text">
                  Publish adult or sexually explicit content without the age gate
                </span>{" "}
                — if your link page contains or links to adult content, you must enable the Ultralink age gate. Adult
                content is permitted only where lawful in your jurisdiction and in the jurisdictions of your audience,
            ...
            <p className="mt-4">
              We reserve the right to remove any content that violates these rules and to suspend or terminate accounts
              accordingly, without notice, at our sole discretion.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>
                Paid plans are billed in advance on a monthly or annual basis. Prices are shown in USD and are inclusive
                of any applicable VAT where required by law.
              </li>
              <li>
                The Creator plan includes a 7-day free trial. No charge is made until the trial ends. If you cancel
                before the trial ends, you will not be charged.
              </li>
              <li>
                By providing payment details, you authorise us to charge your payment method for the applicable
                subscription fee at the start of each billing period.
              </li>
              <li>
                All prices may change with 30 days&apos; notice to existing subscribers. Continued use after the notice
                period constitutes acceptance of the new price.
              </li>
              <li>
                We use Stripe to process payments. Your payment data is subject to Stripe&apos;s privacy policy and
                terms. We do not store your full payment card details.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li>
                Cancellation takes effect at the end of the current billing period. You retain access to paid features
                until then.
              </li>
              <li>Monthly subscriptions: no refunds for partial months.</li>
              <li>
                Annual subscriptions: no refunds, except as required by applicable consumer protection law in your
                jurisdiction (including EU consumer rights).
              </li>
              <li>
                If you cancel the Creator free trial before it expires, you will not be charged and your account reverts
                to the Free plan.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              The Ultralink service, including its software, design, trademarks, and content created by us, is owned by
              Franciszek Kaminski and protected by applicable intellectual property laws.
            </p>
            <p className="mt-3">
              You retain all rights to the content you publish through Ultralink. By publishing content, you grant us a
              limited, non-exclusive, worldwide, royalty-free licence to host, store, display, and deliver your content
              solely for the purpose of operating the service. This licence ends when you delete the content or close
              your account.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              To the maximum extent permitted by applicable law, Ultralink shall not be liable for any indirect,
            ...
            <p className="mt-3">
              Our total liability to you for any claim arising out of or related to these Terms or the service shall not
              exceed the amount you paid us in the 12 months preceding the claim.
            </p>
            <p className="mt-3 text-sm text-text-muted">
              Note: Certain consumer protection laws in Germany and the EU may limit our ability to exclude or restrict
              liability. The exclusions above apply to the fullest extent permitted by law.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may suspend or terminate your account immediately, without prior notice or liability, for any reason
              including — but not limited to — breach of these Terms, especially violations of the acceptable use
              policy.
            </p>
            <p className="mt-3">
              You may terminate your account at any time by deleting it in account settings or by emailing
              support@ultralink.bio. Upon termination, your right to use the service ceases immediately, and your data
          ...
          <section>
            ...
            <p>
              These Terms are governed by the laws of Germany, without regard to its conflict-of-law provisions. Any
              disputes shall be subject to the exclusive jurisdiction of the courts of Germany, except where mandatory
              consumer protection laws in your country of residence provide otherwise.
            </p>
            <p className="mt-3">
              For EU consumers, you may also use the European Commission&apos;s Online Dispute Resolution (ODR) platform
              at <span className="text-text-muted font-mono text-sm">https://ec.europa.eu/consumers/odr</span>.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We may modify these Terms at any time. We will provide at least 30 days&apos; notice of material changes
              via email or a prominent in-app notice. Continued use of the service after the effective date of changes
              constitutes acceptance. If you do not agree to the modified Terms, you must stop using the service and may
      ...
      <footer className="border-t border-border px-4 sm:px-6 py-6 mt-12">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-text-muted">
          ...
          <div className="flex gap-6">
            <Link href="/terms" className="hover:text-text transition-colors text-text-muted">
              Terms of Service
            </Link>
