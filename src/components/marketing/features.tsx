const FEATURES = [
  {
    ...
    description:
      "Replace every link in your bio with a single, beautiful page that loads instantly — even on slow connections.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 24, height: 24 }}>
    ...
    description:
      "See who's clicking, where they're from, what device they're on, and which links convert — not just vanity numbers.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 24, height: 24 }}>
    ...
    title: "Geo-blocking",
    description:
      "Restrict your link page to specific countries — essential for regulated content, geo-licensed products, or regional campaigns.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 24, height: 24 }}>
    ...
    title: "Built-in 18+ age gate",
    description:
      "A compliant, clean age-verification screen — no third-party pop-ups, no workarounds. Your account stays within platform rules.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 24, height: 24 }}>
    ...
    title: "Deep links",
    description:
      "Route visitors directly into your app, specific product pages, or streaming content with properly formed deep link URLs.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ width: 24, height: 24 }}>
    ...
    description:
      "Put your own domain on your link page. Your brand, your URL — not ours. Available on Creator and Agency plans.",
  },
];
